if command -v hledger &>/dev/null; then
  ...
  if [[ -f "$HOME/Documents/ledger/2020/2020.journal" ]]; then
    alias l2020="LEDGER_FILE=$HOME/Documents/ledger/2020/2020.journal"
    alias hledger2020="LEDGER_FILE=$HOME/Documents/ledger/2020/2020.journal hledger"
    alias h2020="LEDGER_FILE=$HOME/Documents/ledger/2020/2020.journal hledger"
  fi
  ...
  alias he='hledger-envelopes'
  alias hen='hledger-envelopes'
  alias hex='hledger-expenses'

  alias hg='hledger-git'
  alias hgs='hledger-git s'
  alias hga='hledger-git add'
  alias hgc='hledger-git c'
